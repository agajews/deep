...
train_data = datasets.ImageFolder(os.path.join(base_dir, 'imgs'), train_tf)
val_data = datasets.ImageFolder(os.path.join(base_dir, 'val_imgs'), val_tf)
...
arch = 'densenet169-augment2-lambda5e-1-lr1e-2'
